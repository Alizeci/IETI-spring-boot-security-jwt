...
import static edu.eci.userapi.utils.Constants.COOKIE_NAME;

/**
 * JwtRequestFilter helps to verify the authorization token send on the request authorization header or using a Cookie
 */
@Component
